...
from config import CISCO_USER_MODE_LOGIN_INFO
...
class Cisco_3700:
    ...
    def get_total_ram(self):
        ...
        CISCO_USER_MODE_LOGIN_INFO['ip'] = self.device
        # add try catch
...
# connection_df, ram_df, cpu_df, unused_port_df, error_df = Cisco_2900('192.168.4.1').formatted_output()
# print(connection_df, '\n', ram_df, '\n', cpu_df, '\n', unused_port_df, '\n', error_df)
